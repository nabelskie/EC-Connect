...
export default function RegisterPage() {
  ...
  return (
    <div className="h-screen-dvh w-full overflow-y-auto bg-background scroll-smooth">
      <div className="flex flex-col items-center justify-center p-4 py-12 md:py-20 min-h-full">
