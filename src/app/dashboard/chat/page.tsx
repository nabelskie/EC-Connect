...
function ChatInboxContent() {
  ...
  const conversations = [
    {
      id: 'RQ1024',
      name: role === 'volunteer' ? 'Mrs. Hapsah (Elderly)' : 'Ahmad (Volunteer)',
      lastMessage: 'Sure thing! Any specific brand you prefer?',
      time: '10:08 AM',
      unread: 1,
      image: role === 'volunteer' ? 'https://picsum.photos/seed/user/100/100' : 'https://picsum.photos/seed/volunteer1/100/100',
      status: 'Online'
    },
    {
      id: 'RQ1023',
      name: role === 'volunteer' ? 'Mr. Lim (Elderly)' : 'Sarah (Volunteer)',
      lastMessage: 'I am on my way to pick up your medicine.',
      time: 'Yesterday',
      unread: 0,
      image: role === 'volunteer' ? 'https://picsum.photos/seed/user2/100/100' : 'https://picsum.photos/seed/volunteer2/100/100',
      status: 'Away'
    }
  ];
